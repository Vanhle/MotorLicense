...
//        processRequest(request, response);
        ...
        request.setAttribute("check", quizDAO.checkAttempt(quizId));
        request.setAttribute("checkQues", quizDAO.checkQuiz(quizId));
...
//        processRequest(request, response);
        ...
        dao.updateQuiz(quizId, quizName, duration, status);
        response.sendRedirect("editQuiz?id=" + quizId + "&mess=Update Success");
    }
