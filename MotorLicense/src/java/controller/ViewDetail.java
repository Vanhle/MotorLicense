...
//        processRequest(request, response);
            String attemptId = request.getParameter("aid");
            ...
            request.setAttribute("listDetail", quizDAO.getAttemptDetailById(Integer.parseInt(attemptId)));
            request.setAttribute("attempt", quizDAO.getAttemptByAttemptId(attemptId));
